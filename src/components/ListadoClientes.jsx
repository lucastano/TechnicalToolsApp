...
import { getClientes , postCliente} from '../Fetchs'
        ...
        <DialogContent>
          <DialogContentText id="alert-dialog-description">
            <div className=' p-2'>
                ...
                <input onChange={(e)=>setNombrePost(e.target.value)} value={nombrePost} className='inputsTxt' type='text' name='nombre' id='nombre'></input>
            </div>
            <div className=' p-2'>
                <label htmlFor='apellido'>Apellido</label>
                <input onChange={(e)=>setApellidoPost(e.target.value)} value={apellidoPost} className='inputsTxt' type='text' name='apellido' id='apellido'></input>
            </div>
            <div className=' p-2'>
                <label htmlFor='telefono'>Telefono</label>
                <input onChange={(e)=>setTelefonoPost(e.target.value)} value={telefonoPost} className='inputsTxt' type='text' name='telefono' id='telefono'></input>
            </div>
            <div className=' p-2'>
                <label htmlFor='email'>Email</label>
                <input onChange={(e)=>setEmailPost(e.target.value)} value={emailPost} className='inputsTxt' type='text' name='email' id='email'></input>
            </div>
             <div className=' p-2'>
                <label htmlFor='direccion'>Dirección</label>
                <input onChange={(e)=>setDireccionPost(e.target.value)} value={direccionPost} className='inputsTxt' type='text' name='direccion' id='direccion'></input>
            </div>
            <div className=' p-2'>
                <label htmlFor='documento'>Documento de identidad</label>
                <input onChange={(e)=>setCiPost(e.target.value)} value={ciPost} className='inputsTxt' type='text' name='documento' id='documento'></input>
            </div>
                        ...
                        clientesMostrados.map((c,i) =>(
                            ...
                            <td className='txtRows '>
                                ...
                                <div className='bg-green-700 cursor-pointer text-white flex items-center justify-center w-7 h-7 m-1' title='Agregar reparación'>
                                    ...
                                    <svg  onClick={()=>handleNuevaReparacion(c.ci)} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
