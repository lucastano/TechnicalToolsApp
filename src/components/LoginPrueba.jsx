...
export const LoginPrueba = ({setAutenticacion}) => {
    ...
    const [errorLoginDsc, seterrorLoginDsc] = useState("error")
        ...
        if(user != "" && pass != "" && rol!=""){
            ...
            try
            {
                ...
                { 
                    ...
                    console.log('entra al else en login')
                    setloading(false)
                    seterrorLogin(true)
            ...
            <div className="flex min-h-full flex-1 flex-col justify-center px-6 py-12 lg:px-8">
                ...
                <div className="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
                    <form action="#" method="POST" className="space-y-6">
                        ...
                        {/* esto cambia la opacidad del elemento segun el estado de loading, porque sino cuando se  debe mostrar 
                        se agranda el componente, entonces no quiero eso y por eso en lugar de ocultar el elemento 
                        le cambio la opacidad, pero queda muy grande, entonces tengo que darle un ancho fijo al div 
                        y mostrar un elemento u otro dependiendo del estado de loading */}
                        <div className='h-5' >
                            {loading &&
                            ...
                            { errorLogin &&
                                 <p className={`alertErrorLogin`}>{errorLoginDsc}</p> 
                            }   
